				...
				<div>
                  ...
                  />
							...
							<TabPanel>
								<h3>
									Ambassador Events{' '}
									<Link to="/add-event/ambassador">
										Add Ambassador Event
									</Link>
								</h3>
								<EventListing
									events={events.filter(
...
export default withRouter(
	query('events', EventScreen, {
		variables: { year: '20', showInactive: true }
	})
)
